...
(function () {
    ...
    var root = typeof self === 'object' && self.self === self && self ||
        ...
        this;
    /**
     * kla1626gwa  bekommt über getCache pivotdata oder yearlats(?)
    ...
    kla1626gwa.show = function (parameters, navigatebucket) {
        ...
        $(".headertitle").attr("title", "kla1626gwa");
        $(".content").attr("pageid", "kla1626gwa");
        $(".content").attr("id", "kla1626gwa");
        $(".content")
            .css({
                overflow: "hidden"
            });
        ...
        sysbase.initFooter();
        $("#kla1626gwa.content").empty();
        $("#kla1626gwa.content")
            .append($("<div/>", {
                id: "kla1626gwabuttons",
                css: {
                    width: "100%",
                    float: "left"
                }
        ...
        $("#kla1626gwabuttons")
                ...
                click: function (evt) {
                    ...
                    async.waterfall([
                        function (cb1625a) {
                            ...
                            $("#kla1626gwawrapper").empty();
                            $("#kla1626gwawrapper").css({
                                overflow: "auto"
                            });
                            $("#kla1626gwawrapper")
                                .append($("<div/>", {
                            ...
                            kla1626gwa.kliheatmap2("kla1626gwad1", "WLVL", selsource, selstationid, starecord, hmoptions, function (ret) {
                                cb1625a(null);
                            });
                        },
                        function (cb1625b) {
                            ...
                            kla1626gwa.kliheatmap2("kla1626gwad2", "WLVL", selsource, selstationid, starecord, hmoptions, function (ret) {
                                cb1625b(null);
                            });
                        },
                        function (cb1625c) {
                            ...
                            kla1626gwa.kliheatmap2("kla1626gwad3", "WLVL", selsource, selstationid, starecord, hmoptions, function (ret) {
            ...
            .append($("<button/>", {
                ...
                click: function (evt) {
                    // sysbase.printDivAll($("#kla1626gwawrapper").html());
            ...
            .append($("<button/>", {
                ...
                click: function (evt) {
                    ...
                    if ($("#kliheattable").is(":visible")) {
                        ...
                        var w = $("#kla1626gwa.content").width();
                        w -= 0; // $("#heatmap").position().left;
                        w -= 0; // $("#heatmap").width();
                        w -= 0; // 40;
                        $("#kla1626gwawrapper")
                            .append($("<div/>", {
                                id: "kla1626gwacolormap",
                                css: {
                        ...
                        $("#kla1626gwacolormap").show();
                        kla9020fun.getColorPaletteX1("kla1626gwacolormap", 7);
                    }
                    return false;
                }
            }))
        ...
        /**
         * Beginn des initialen Aufbaus kla1626gwawrapper
         */
        $("#kla1626gwa.content")
            .append($("<div/>", {
                    id: "kla1626gwadiv",
                ...
                .append($("<div/>", {
                    id: "kla1626gwawrapper",
                    class: "kla1626gwawrapper"
                }))
            );
        var h = $("#kla1626gwa").height();
        h -= $("#kla1626gwa.header").height();
        h -= $("#kla1626gwabuttons").height();
        h -= $("#kla1626gwa.footer").height();
        $("#kla1626gwadiv")
            .css({
                "margin": "10px",
        ...
        console.log("kla1626gwawrapper initialisiert, leer");
        ...
        if (kla1626gwaconfig.allin === false) {
            ...
            kla1626gwa.loadalldata(function (ret) {
                ...
                kla1626gwa.showall(ret);
            });
        } else {
            kla1626gwa.getmoredata(function (ret) {
                var wmtit = "Auswertung für Station:";
                // isMember ? '$2.00' : '$10.00'
    ...
    /**
     * alle Daten laden - kla1626gwaconfig.allin auswerten für Differenzierung
     * allin === false, dann selstationid abfragen
     * allin === true, dann selstationids als Array abfragen
     */
    kla1626gwa.loadalldata = function (cb1625g) {
        async.waterfall([
                function (cb1625g1) {
                    kla1626gwaclock = kla1626gwa.showclock("#kla1626gwaclock");
                    //$("button").hide();
                ...
                function (ret, cb1625g4) {
                     ...
                     */
                    if (kla1626gwaconfig.hyde === false) {
                        cb1625g4(null, ret);
                        return;
                    }
                    var jqxhr = $.ajax({
    ...
    /**
     * getmoredata - kla1626gwaconfig.allin === true
     ...
     */
    kla1626gwa.getmoredata = function (cb1625n) {
                ...
                function (ret1, cb1625n1) {
                    ...
                    async.eachSeries(ret1.records, function (klirow, nextklirow) {
                        if (vglsource === "" && vglstationid === "") {
                            ...
                            kla1626gwa.execmoredata(vglsource, vglstationid, function (ret2) {
     ...
     * @param {*} cbexec
     */
    kla1626gwa.execmoredata = function (newsource, newstationid, cb1625p) {
        selsource = newsource;
        ...
        async.waterfall([
                ...
                function (ret, cb1625p5) {
                    ...
                    kla1626gwa.showall(ret, function (ret1) {
    ...
    /**
     * kla1626gwa.showall - Aufruf aller Funktionen für die Standardauswertung
     * @param {*} ret
     */
    kla1626gwa.showall = function (ret, cball) {
        /**
         * einbahnige Ausgabe nach kla1626gwawrapper
         */
        hmatrixL = {};
        hoptionsL = {};
        ...
        */
        ...
        async.waterfall([
                function (cb1625g0a) {
                    ...
                    if (kla1626gwaconfig.allin === true) {
                     ...
                     * Stammdaten
                     */
                    if (kla1626gwaconfig.master === false) {
                        cb1625g0a(null, ret);
                        return;
                    }
                ...
                function (ret, cb1625g0) {
                     ...
                     */
                    if (kla1626gwaconfig.qonly === false) {
                        cb1625g0(null, ret);
                        return;
                    }
                    var divid = "D" + Math.floor(Math.random() * 100000) + 1;
                ...
                function (ret27, cb1625g1) {
                     ...
                     */
                    var divid = "D" + Math.floor(Math.random() * 100000) + 1;
                    if (kla1626gwaconfig.heatmaps === true || kla1626gwaconfig.heatmapsx === true) {
                        $("#kla1626gwawrapper")
                            .append($("<div/>", {
                                    css: {
                                        width: "100%",
                    ...
                    kla1626gwa.kliheatmap2("#" + divid + "L", "WLVL", selsource, selstationid, starecord, hmoptions, function (ret) {
                        ret.divid = divid;
                ...
                function (ret, cb1625g5a) {
                     ...
                     */
                    if (kla1626gwaconfig.tempdistribution === false) {
                        cb1625g5a(null, ret);
                        return;
                    }
                    /**
                    ...
                    var distrs = {};
                    var maxy = 0;
                    distrs["WLVL"] = kla1626gwa.klidistr2calc("WLVL", selsource, selstationid, ret);
                    // Konsolidierung und
                    /*
                    ...
                    */
                    ...
                    ret.distrs = distrs;
                    kla1626gwa.klidistr2("#" + divid + "L", "WLVL", selsource, selstationid, ret, function (ret1) {
                        ret.divid = divid;
                        ret.distrs = distrs;
                        cb1625g5a(null, ret);
                        return;
                ...
                function (ret, cb1625g5) {
                    ...
                    kla1626gwa.klihisto2("#" + divid + "L", "WLVL", selsource, selstationid, starecord, hmatrixL, hoptionsL, function (ret) {
                        ret.divid = divid;
                        cb1625g5(null, ret);
                        return;
                    });
                ...
                function (ret, cb1625g7) {
                    ...
                    hoptionsL.minmaxhistogram = true;
                    kla1626gwa.klitemp2("#" + divid + "L", "WLVL", selsource, selstationid, starecord, hmatrixL, hoptionsL, function (ret) {
                        ret.divid = divid;
                        cb1625g7(null, ret);
                        return;
                    });
                ...
                function (ret, cb1625g9) {
                    ...
                    var hmoptions = {};
                    kla1626gwa.klihyde2("#" + divid, selstationid, starecord, function (ret) {
                        cb1625g9("Finish", ret);
                        return;
                    });
                }
     ...
     * @param {*} callbackh0
     */
    kla1626gwa.kliheatmap2 = function (cid, selvariablename, selsource, selstationid, starecord, hmoptions, callbackh0) {
        ...
        async.waterfall([
                function (callbackshm2) {
                    ...
                    try {
                        ...
                        ret.record.fromyear = kla1626gwaconfig.fromyear;
                        ret.record.toyear = kla1626gwaconfig.toyear;
                        ...
                        for (var year in years) {
                            if (years.hasOwnProperty(year)) {
                                if (parseInt(year) < kla1626gwaconfig.fromyear || parseInt(year) > kla1626gwaconfig.toyear) {
                                    continue;
                                }
                                        ...
                                        if (hmoptions.minmax === true) {
                                            ...
                                            if (!isNaN(hmval)) {
                                                ...
                                                if (hmoptions.cbuckets === true) {
                                                    ...
                                                    var steps = parseInt(kla1626gwaconfig.step || 30);
                ...
                function (ret, callbackshm4) {
                    ...
                    // kla1626gwa.paintT(selvariablename, selsource, selstationid, ret.matrix);
    ...
    kla1626gwa.klihisto2 = function (cid, selvariable, selsource, selstationid, starecord, hmatrix, hoptions, cb1625h) {
        var ret = {
            error: false,
            message: ""
        };
        ...
        if (hoptions.minmax === true && typeof hoptions.histo === "object" && Object.keys(hoptions.histo).length > 0) {
            ...
            if (hoptions.cbuckets === true && typeof hoptions.cbucketdata === "object" && Object.keys(hoptions.cbucketdata).length > 0) {
                ...
                if (kla1626gwaconfig.temptable === true) {
                    $(cid)
                        .append($("<h3/>", {
            ...
            */
            if (kla1626gwaconfig.decimals === true) {
    ...
    /**
     * kla1626gwasplit - Splitten Sommer/Winter Histogramm
     * in neue Zeilen der Zieltabelle
     * starecord hat source, stationid
     * klirecords[0] oder [1] mit variable
     */
    $(document).on("click", ".kla1626gwasplit", function (evt) {
        evt.preventDefault();
        evt.stopImmediatePropagation();
        evt.stopPropagation();
     ...
     */
    kla1626gwa.klidistr2calc = function (selvariable, selsource, selstationid, ret1) {
        //Chart.defaults.global.plugins.colorschemes.override = true;
        //Chart.defaults.global.legend.display = true;
        // https://nagix.github.io/chartjs-plugin-colorschemes/colorchart.html
        var yAxesticks = [];
        ...
        if (typeof kla1626gwaconfig.fromyear === "undefined") {
            var year1 = uihelper.getwmobucket(selparms.fromyear).fromyear;
            var year2 = uihelper.getwmobucket(selparms.toyear).toyear;
            kla1626gwaconfig.fromyear = year1;
            kla1626gwaconfig.toyear = year2;
            kla1626gwaconfig.step = 30;
        }

        var distfromyear = parseInt(kla1626gwaconfig.fromyear);
        var disttoyear = parseInt(kla1626gwaconfig.toyear);
        var diststep = parseInt(kla1626gwaconfig.step);
        var sunbucket = {};
        var winbucket = {};
        var ibucket = 0;
    ...
    /**
     * kla1626gwa.klidistr2 - tempdistribution
     * Separate Charts für Sommer und Winter für die Distribution
     * starecord hat source, stationid
     * klirecords[0] oder [1] mit variable
     */
    kla1626gwa.klidistr2 = function (cid, selvariable, selsource, selstationid, ret1, cb1625p) {
        try {
            var divid = "div" + Math.floor(Math.random() * 100000) + 1;
    ...
    /**
     * kla1626gwa.klitemp2 Wasserstand-Sparkline über Klima-Buckets
     * @param {*} cid
     * @param {*} selvariable
     * @param {*} selsource
     * @param {*} selstationid
    ...
    /**
     * kla1626gwa.klihyde2 - Ausgabe der HYDE-Daten
     ...
     */
    kla1626gwa.klihyde2 = function (cid, selstationid, starecord, cb1625j) {
     ...
     */
    kla1626gwa.showclock = function (clockcontainer) {
